...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   pipex_bonus_no_globals.c                          :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
/*   By: wsm <wsm@student.42.fr>                    +#+  +:+       +#+        */
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/08/11 12:00:00 by wsm               #+#    #+#             */
/*   Updated: 2024/08/11 12:00:00 by wsm              ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/* 
** Solution 1: Store PIDs in an array and wait for them at the end
** This eliminates the need for a global counter
*/
...
/* Main function with PID array approach - NO GLOBALS! */
int	main(int argc, char **argv, char **envp)
{
	...
	// Allocate PID array (max possible commands)
	max_pids = argc - 3;  // Maximum possible middle commands
